...
# files, and dependency installs don't come along — the app won't build until
# they do. Run this once per worktree.
#
...
echo "[bootstrap] core is linked in-process by the Tauri host; no sidecar staging needed."
...
echo "[bootstrap] done. launch with:  pnpm dev:app"
