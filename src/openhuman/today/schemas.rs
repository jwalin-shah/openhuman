...
mod tests {
    ...
    fn all_controller_schemas_has_feed_list() {
        ...
        assert_eq!(schemas[0].function, "feed_list");
        assert_eq!(schemas[0].namespace, "today");
    }

    #[test]
    fn all_registered_controllers_has_one_entry() {
        let controllers = all_registered_controllers();
        assert_eq!(controllers.len(), 1);
        assert_eq!(controllers[0].schema.function, "feed_list");
    }
